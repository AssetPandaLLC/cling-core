...
public class RemoteDeviceIdentity extends DeviceIdentity {
    ...
    public String toString() {
		...
		return "RemoteDeviceIdentity [descriptorURL=" + descriptorURL + ", interfaceMacAddress="
		+ Arrays.toString(interfaceMacAddress) + ", discoveredOnLocalAddress=" + discoveredOnLocalAddress + "]";
	}
